                ...
                <div class="inquiry">
                    ...
                    <div class="inquiry-options ">
                        <div class="inquiry-group">
                            <label>
                                <input type="checkbox" name="inquiry[]" class="checkbox" value="Website"><span>Website</span>
                            </label>
                        </div>
                        <div class="inquiry-group">
                            <label>
                                <input type="checkbox" name="inquiry[]" class="checkbox" value="Mobile app"><span>Mobile
                                    app</span>
                            </label>
                        </div>
                        <div class="inquiry-group">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.get-in-touch-btn').click(function(e) {
                ...
                popUpForm.show();
                $('.pop-up-form-bg').css("display","flex");
